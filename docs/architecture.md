...
```
pip install sentinel-kernel[langchain]   # LangChain integration
pip install sentinel-kernel[postgres]    # PostgreSQL backend
pip install sentinel-kernel[otel]        # OpenTelemetry export
```
