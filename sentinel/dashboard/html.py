...
footer .commercial-footer a {
  color: var(--text2);
  text-decoration: none;
  border-bottom: 1px dotted var(--border);
}
footer .commercial-footer a:hover { color: var(--green); }
...
<footer>
  ...
  <div class="commercial-footer">
    Need deployment support, audit preparation, or BSI pre-certification?
    <a href="mailto:sentinel@swentures.com">sentinel@swentures.com</a>
  </div>
</footer>
