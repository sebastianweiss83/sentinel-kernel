...
(function() {
  var el = document.getElementById('days-count');
  var el2 = document.getElementById('days-count-2');
    ...
    <div class="inside-grid">
      ...
      <div>
        <table class="compliance-table">
          <thead>
            <tr><th>Article</th><th>Requirement</th><th>Sentinel</th></tr>
          </thead>
          <tbody>
            <tr><td class="art">Art. 12</td><td>Auto logging</td><td class="full">✓ Full</td></tr>
            <tr><td class="art">Art. 13</td><td>Transparency</td><td class="full">✓ Full</td></tr>
            <tr><td class="art">Art. 14</td><td>Human oversight</td><td class="full">✓ Full</td></tr>
            <tr><td class="art">Art. 9</td><td>Risk management</td><td class="partial">~ Partial</td></tr>
            <tr><td class="art">Art. 17</td><td>Quality management</td><td class="partial">~ Partial</td></tr>
            <tr><td class="art">Art. 10</td><td>Data governance</td><td class="human">→ Human action</td></tr>
            <tr><td class="art">Art. 15</td><td>Accuracy</td><td class="human">→ Human action</td></tr>
          </tbody>
        </table>
        <div class="note" style="margin-top:1rem;">
          Sentinel is honest about what can and cannot be automated.
          Articles requiring human action are clearly marked.
        </div>
      </div>
    </div>
  </div>
