...
Any US-incorporated entity in the trace emission path creates CLOUD Act exposure.
An EU data centre run by a US company does not solve this.
US services may appear only in optional integrations, clearly marked.
...
Does NOT mean: you cannot use code written by Americans.
