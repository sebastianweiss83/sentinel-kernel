...
.l4  { animation-delay: 1.6s; }
.l5  { animation-delay: 1.8s; }
.l6  { animation-delay: 2.4s; }
.l7  { animation-delay: 2.7s; }
.l8  { animation-delay: 3.0s; }
.l9  { animation-delay: 3.3s; }
.l10 { animation-delay: 3.6s; }
.l11 { animation-delay: 4.0s; }
.l12 { animation-delay: 4.3s; }
@keyframes fade-in {
  from { opacity: 0; }
  to   { opacity: 1; }
}
...
.pill.allow { background: rgba(52, 211, 153, 0.15); color: var(--green); }
...
.try .step { font-family: ui-monospace, monospace; background: #0a0e14; padding: 0.9rem 1.4rem;
             border-radius: 4px; display: inline-block; margin: 0.3rem 0; color: var(--green); font-size: 0.95rem; }
...
<div class="terminal">
  <div class="terminal-bar">
    ...
    <span class="title">~/projects — terminal</span>
  </div>
  <div class="terminal-body">
    ...
    <div class="line l12 success">Report: sentinel_demo_report.html</div>
  </div>
</div>
"""
...
<svg viewBox="0 0 720 720" xmlns="http://www.w3.org/2000/svg" role="img"
  ...
  <defs>
    ...
    <style>
      ...
      .tag        { font: 700 11px ui-monospace, monospace; fill: #34d399; }
  ...
  <div class="container">
    ...
    <div class="tabs">
      <div class="tab-headers">
        <button class="tab-btn active" data-tab="cli">Evaluate (CLI)</button>
        <button class="tab-btn" data-tab="minimal">Python SDK</button>
      ...
      <div id="tab-cli" class="tab-panel active"><pre><span class="cm"># Install + full end-to-end demo (no code required)</span>
...
<span class="cm"># lives in sentinel-kernel[pqc] — see docs/sentinel-evidence.md</span>

<span class="cm"># Optional RFC-3161 timestamping via EU-sovereign TSAs</span>
<span class="cm"># (DFN-CERT, D-Trust) — sentinel.crypto.RFC3161Timestamper</span></pre></div>
...
docker compose -f docker-compose.minimal.yml up</pre>
      <div class="small">Then open http://localhost:3001 (Grafana · admin / sentinel)</div>
    </div>
  </div>
</section>
"""
